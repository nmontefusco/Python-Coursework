...
#initializing paddles position and velocity, and score
...
def keydown(key):
    global paddle1_vel, paddle2_vel,paddle_accel
   
  #player1 control scheme  
